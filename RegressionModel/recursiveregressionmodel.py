...
def plot_compare_graph(graph_base, graph_user, graph_other, frames):
    fig = plt.figure()
...
def plot_output(world_coord_base: np.array, world_coord_user: np.array, outputs: list):
    ...
    plot_compare_graph(graph_user, graph_temp, graph_base, new_base.shape[0]) # 1 red, 2 blue, 3 green
...
def main():
    ...
    plot_output(new_base, new_user, outputs)
